    ...
    return (
        <Document>
            <Page style={styles.body}>
                ...
                <Text style={styles.description}>Atesto, para os devidos fins, que o(a) Sr(a) __________________________________________</Text>
                <Text style={styles.description}>_____________________________________________________________________________</Text>
...
export function DownloadAtestado() {
    return (
        useMemo(
            () => (
                <PDFDownloadLink document={<Atestado />} fileName="atestado.pdf">
